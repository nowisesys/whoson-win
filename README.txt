This is the client side application for the whoson web service. It is part of an 
application suite that together forms an centralized logon accounting service.
...
** BUFFER SIZES:
   ...
   get listings work.  These are set in whoson.exe.config (app.config in source code), 
   increase the value of maxReceivedMessageSize and maxBufferSize as needed.
